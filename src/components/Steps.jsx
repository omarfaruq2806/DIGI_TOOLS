...
const Steps = () => {
  return (
    <div className="bg-gray-50 px-32 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
        <div className="bg-white shadow-md rounded-2xl p-8 text-center space-y-3">
          <img src={user} alt="User" className="mx-auto bg-purple-100 rounded-full p-3"/>
        ...
        <div className="bg-white shadow-md rounded-2xl p-8 text-center space-y-3">
          <img src={Package} alt="Package" className="mx-auto bg-purple-100 rounded-full p-3"/>
          <h2 className="text-2xl font-bold">Choose Products</h2>
          <p>Browse our catalog and select the tools that fit your needs.</p>
        </div>
        <div className="bg-white shadow-md rounded-2xl p-8 text-center space-y-3">
          <img src={rocket} alt="Rocket" className="mx-auto bg-purple-100 rounded-full p-3"/>
